...
import { FeedSnippetsPanel } from "../_components/FeedSnippetsPanel";
import { AssistantOverlay } from "../_components/AssistantOverlay";
      ...
      <div className="relative">
        ...
        <section className="grid gap-6 lg:grid-cols-[2fr,1fr]">
          <div className="space-y-6">
            ...
            <FeedSnippetsPanel
              title="Laundry feed"
              subtitle="Laundry & care stories from creators and suppliers."
              limit={4}
            />
          </div>
        ...
        <AssistantOverlay
          taxonomy={[
            { label: "Laundry feed", description: "See laundry collabs + care creators.", href: "/feed" },
            { label: "Drivers", description: "Coordinate pickups & share GPS.", href: "/drivers/dashboard" },
            { label: "Suppliers", description: "Manage washhouses & payouts.", href: "/suppliers/dashboard" },
          ]}
        />
      </div>
    </HydrateClient>
