...
export default function AdminApplyPage() {
  ...
  const submit = () => {
    ...
    apply.mutate({ type: "ADMIN", name, email, phone: phone || undefined, resumeUrl: resumeUrl || undefined, answers: { notes }, source: "admins-apply" });
  };

  return (
    <main className="mx-auto max-w-2xl p-6">
      <nav className="mb-3 text-sm"><Link href="/" className="text-blue-700 hover:underline">← Home</Link></nav>
      <h1 className="mb-2 text-2xl font-bold">Operations Admin Application</h1>
